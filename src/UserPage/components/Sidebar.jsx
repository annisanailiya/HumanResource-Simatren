...
import { DASHBOARD_SIDEBAR_BOTTOM_LINKS, DASHBOARD_SIDEBAR_LINKS, DASHBOARD_SIDEBAR_TOP_LINKS } from "./content/NavigationUser";
    ...
    <div className={`transition-width duration-300 ease-in-out sticky top-0 h-screen w-64 bg-green-900 flex flex-col text-white ${isOpen ? "block" : "hidden"} md:block`}>
      ...
      <div className="flex-initial w-64 px-5">
        ...
        <div>
          ...
          {isDropdownOpen && (
            <div className="pl-7">
              <DropdownLink to="/UserPage/histori_presensi" label="Histori Presensi" icon={<RiHistoryFill />} />
              <DropdownLink to="/UserPage/qr_presensi" label="Scan QR" icon={<BiQrScan />} />
            </div>
          )}
        </div>
